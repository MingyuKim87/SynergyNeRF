...
class System_Config:
    seed: int = 20220401
    basedir: str = "./results/SynergyNeRF"
...
class Model_Config:
    ...
    curriculum_start : Optional[float] = 0.1
    ...
    TV_t_s_ratio: float = 2.5  # ratio of TV loss along temporal and spatial dimensions
...
@dataclass
class Data_Config:
    datadir: str = "./data/D_nerf_synthetic"
    scene: str = "lego"
...
class Config:
    ...
    render_disentangled : bool = False # only for tensorrefine_disentangled
