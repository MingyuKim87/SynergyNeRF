...
To run this code on GPUs with 24GB of VRAM, you should use the configuration files located in `config/SynergyNeRF/revised_cfg/`.  If you want to run the code as described in the original paper, please use the configuration files found in `config/SynergyNeRF_disentangled/official/`.  
```bash
